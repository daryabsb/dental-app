<template>
    <div>
        ...
        <select v-model="src" style="width: 30em">
            <option v-for="item in pdfList" :value="item" :key="item" v-text="item"></option>
        </select>
        ...
        <div style="width: 50%">
            ...
            :src="src" 
            :page="i" 
             @num-pages="numPages = $event" ></pdf-view>
        </div>
    </div>
</template>
<script> 
export default {
    ...
    data () {
        return {
            ...
            pdfList: [
                '',
                '"http://127.0.0.1:8000/media/upload_files/LK.pdf',
                'http://127.0.0.1:8000/media/upload_files/Fig_72_-_MOIT_-_PROPOSAL_wF08UCi.pdf',
